                ...
                with st.spinner("Analyzing " + app_name + "..."):
                    ...
                    st.markdown(f"""
                        <div style="background: rgba(177, 151, 252, 0.05); border: 1px solid #3E7096; padding: 20px; border-radius: 15px; margin-bottom: 20px;">
                            ...
                            <a href="{COMMERCIAL_TIER_LINK}" target="_blank">
                                <button style="background-color: #3E7096; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold; width: 100%;">Start Commercial Tier - $12.00</button>
                            </a>
                        </div>
